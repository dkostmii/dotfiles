...
static const char *fonts[]          = { "Unifont:pixelsize=16" };
static const char dmenufont[]       = "Unifont:pixelsize=16";
static const char st_shell[]        = "fish";
static const char st_font[]        = "Unifont:pixelsize=16";
...
/* tagging */
static const char *tags[] = { "1", "2", "Dev", "Fun", "Office", "Web" };
...
static const Rule rules[] = {
	...
	{ NULL,             NULL,       "SoundCloud",       1 << 3,            0,           -1 },
	{ NULL,             NULL,       "YouTube",          1 << 3,            0,           -1 },
};
